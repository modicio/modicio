...
trait ModelVerifierJ extends ModelVerifier {

  override final def verify(typeHandle: TypeHandle): Boolean = verifyJ(typeHandle)

  def verifyJ (typeHandle: TypeHandleJ): Boolean
