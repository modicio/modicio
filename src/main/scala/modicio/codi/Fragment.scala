...
import Fragment.composeSingletonIdentity
import modicio.codi.datamappings.{FragmentData, RuleData}
import modicio.codi.rules.{AssociationRule, AttributeRule}
import modicio.codi.values.ConcreteValue
import modicio.util.Observer
 ...
 * its child classes [[Node Node]] and [[BaseModel BaseModel]]
 * <p> Apart from the constructor arguments, the Fragment possess a [[Definition Definition]], a [[Registry Registry]], a
...
abstract class Fragment(val name: String, val identity: String, val isTemplate: Boolean) {
  ...
  /**
   * <p>Abstract method to get if the concrete implementation is a [[Node Node]]. It must be a
   * [[BaseModel BaseModel]] otherwise.
   *
  ...
  /**
   * <p> Add a [[Rule Rule]] to this Fragment.
   * <p> See the concrete implementations for more information.
   * <p> A concrete implementation may require the Fragment to be unfolded!
  ...
  /**
   * <p> Remove a [[Rule Rule]] from this Fragment.
   * <p> See the concrete implementations for more information.
   * <p> A concrete implementation may require the Fragment to be unfolded!
   * <p> A concrete implementation may change the fold state of the Fragment
   *
   ...
   * <p> A concrete implementation may require the Fragment to be unfolded!
   *
   * @return (FragmentData, Set[RuleData]) - tuple of [[FragmentData FragmentData]] and
   *         [[RuleData RuleData]]
   */
  private[modicio] def toData: (FragmentData, Set[RuleData])
  ...
  /**
   * <p> Fork this Fragment. This operation creates a copy of Fragment and [[Definition Definition]] with
   ...
   * <p> A [[Registry Registry]] must be available to this Fragment because not available data is lazily reloaded.
  ...
  /**
   * <p> Checks if this Fragment is valid by the means of the provided [[ModelVerifier ModelVerifier]]
   ...
   *
   * @return Boolean - if this Fragment and its [[Definition Definition]] is valid
   */
  def isValid: Boolean = {
   ...
   * <p> This operation is by default used by the [[TypeFactory TypeFactory]] during Fragment construction only.
   *
   ...
   *
   * @return a [[TypeHandle TypeHandle]] created from this Fragment.
   ...
   * [[Definition Definition]] which target a certain other Fragment i.e. this method returns
  ...
  /**
   * <p> The same as [[Fragment#getAssociationRulesOfType Fragment.getAssociationRulesOfType()]] but considers
  ...
  /**
   * <p> The same as [[Fragment#getAssociationRulesOfRelation Fragment.getAssociationRulesOfRelation()]] but considers
   * the complete extension hierarchy.
   * <p> <strong>The Fragment needs to be unfolded to perform this operation.</strong>
   *
   * @param relationName of the association relation to query
